...
Page({
    ...
    onLoad:function(options) {
      ...
      let that=this;
        wx.request({
          url: 'http://121.36.207.124//apis/link/',
          method:'GET',
          data:{
          },
          success: function(res){
            ...
            console.log(res);
            zong = res.data.Course_informations;
            for(var i=0;i<zong.length;i++){
              if(zong[i].week==riqi){
                teachers.push(zong[i]);
              }
            }
    ...
    resultlist: function(e){
      ...
      wx.navigateTo({
        url: '/packC1/pages/ddddm/ddddm?&classname=' + teachers[index].course+ '&building=' +teachers[index].building+'&classroom='+teachers[index].classroom+'&classdate='+riqi+'&classtime='+teachers[index].time_period+'&cid='+teachers[index].course_id,
      })
    }
})